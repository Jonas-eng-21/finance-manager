...
class TransactionRepositoryImplTest {
    ...
    void should_filter_transactions_dynamically() {
        ...
        PaginatedResult<Transaction> result1 = transactionRepository.findByFilter(filter1);
        ...
        TransactionFilterDTO filter2 = new TransactionFilterDTO(
                userId, null, null, null, 10L, 0, 10
        );
        PaginatedResult<Transaction> result2 = transactionRepository.findByFilter(filter2);
